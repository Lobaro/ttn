...
4. Make sure you have [Redis](http://redis.io/download) and [RabbitMQ](https://www.rabbitmq.com/download.html) **installed** and **running**. For a fresh installation you might need install the [MQTT plugin](https://www.rabbitmq.com/mqtt.html).  
